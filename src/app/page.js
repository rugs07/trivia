...
export default function Home() {
  ...
  <h1 className="text-3xl md:text-4xl font-bold mb-6 text-center">Welcome to GeoExplorer Trivia</h1>
  ...
  <div className="bg-white rounded-lg shadow-lg p-6 text-gray-800 w-full max-w-md">
    <h2 className="text-xl md:text-2xl font-semibold mb-4 text-center">Choose Difficulty</h2>
